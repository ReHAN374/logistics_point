                    ...
                    @if (isset($invoices))
                        <tbody>
                            @foreach ($invoices as $key => $invoice)
                                <tr id="warehouse-row-{{ $invoice->id }}">
                                    <th scope="row">{{ $invoices->firstItem() + $key }}</th>

                                    <td>{{ $invoice->invoice_no }}</td>
                                    <td class="text-center">{{ $invoice->customer_name }}</td>
                                    <td class="text-center">{{ $invoice->vat_no }}</td>
                                    <td class="text-center">{{ $invoice->vat_amount }}</td>
                                    <td class="text-center">{{ $invoice->grand_total }}</td>
                                    <td class="text-center">{{ $invoice->user_name }}</td>
