                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-info btn-sm"
                                            onclick="getBalanceNoteItems({{ $issue_note->warehouse_id }},{{ $issue_note->issue_note_id }})">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                        </form>
                                    </td>
                        ...
                        <div class="container px-0">
                            <div class="mt-4">
                                                ...
                                                <table class="table table-bordered" id="balance_note_item_table">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Warehouse</th>
                                                            <th style="width:12px">Product</th>
                                                            <th class='text-center' style="width:160px">O/Qty</th>
                                ...
                                <div class="d-flex justify-content-end mt-3">
                                    <button class="btn btn-primary mr-2" id="balanceItems">Submit Items</button>
